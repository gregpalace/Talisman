        ...
        {!disabled && (
          <>
            <div className='flex-column'>
              <div
                className={`flex-row ${sideMenu ? '' : 'stats__row--spacing'}`}
              >
                <span className='stats__text--spacing'>{'LEVEL: '}</span>
                <span className='stats__text--level'>{level}</span>
              </div>
              ...
              >
                <span className='exp-bar__container'>
                  <span className='flex-row stats-bar__text'>{'EXP'}</span>
                  <span
            ...
            <div className={`flex-column ${columnStyle}`}>
              <div
                className={`flex-row ${sideMenu ? '' : 'stats__row--spacing'}`}
              >
                <span className='stats__text--spacing'>{'ATK: '}</span>
                <span className='stats__text--damage'>{damage}</span>
              </div>

              <div className='flex-row'>
                <span className='stats__text--spacing'>{'DEF: '}</span>
                <span className='stats__text--defence'>{defence}</span>
              </div>
            </div>
            ...
            <div className={`flex-column ${columnStyle}`}>
              ...
              >
                ...
                >
                  <span className='stats-hp-bar__container'>
                    <span className='flex-row stats-bar__text'>{'HP'}</span>
                    <span
              ...
              <div className='flex-row'>
                <span className='stats__text--spacing'>{'GOLD: '}</span>
                <span className='stats__text--gold'>{gold}</span>
              </div>
            </div>
          </>
        )}
